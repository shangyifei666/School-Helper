...
public class MyRecriveServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(ConnectionBean con:connectionList) {
			System.err.println(con.getConnectionId());
			System.err.println(con.getPosterId());
			System.err.println(con.getRecriverId());
			System.err.println(con.getRewardId());
			RewardDao redao=new RewardDao();
			rewardList = redao.MyPublish(con.getPosterId());
