...
public class TaskSecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_task_second, container, false);
        ...
        ListView listView = view.findViewById(R.id.lv_task_second);
